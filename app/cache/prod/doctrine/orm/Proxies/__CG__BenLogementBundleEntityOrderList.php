 ...
 */
class OrderList extends \Ben\LogementBundle\Entity\OrderList implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'ids', 'status', 'length', 'created', 'logement');
    }
