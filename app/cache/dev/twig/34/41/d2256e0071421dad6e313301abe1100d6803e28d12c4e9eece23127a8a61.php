...
<nav id=\"adminmenu\">
    <ul class=\"top-menu\">
        <li class=\"";
        // line 18
        if (((isset($context["route"]) ? $context["route"] : $this->getContext($context, "route")) != "ben_dashboard")) {
            echo "not-";
        }
        echo "current\"><a href=\"";
        ...
        <li class=\"";
        // line 19
        if (!twig_in_filter((isset($context["route"]) ? $context["route"] : $this->getContext($context, "route")), (isset($context["personMenu"]) ? $context["personMenu"] : $this->getContext($context, "personMenu")))) {
            echo "not-";
        }
        ...
        echo "\" ";
        if ((array_key_exists("status", $context) && ((isset($context["status"]) ? $context["status"] : $this->getContext($context, "status")) == "valide"))) {
            echo "class=\"active\"";
        }
        ...
        echo "\" ";
        if (twig_in_filter((isset($context["route"]) ? $context["route"] : $this->getContext($context, "route")), array(0 => "etudiant_generate_list"))) {
            echo "class=\"active\"";
        }
        ...
        echo "\" ";
        if (twig_in_filter((isset($context["route"]) ? $context["route"] : $this->getContext($context, "route")), array(0 => "etudiant_elegible"))) {
            echo "class=\"active\"";
        }
        ...
        echo "\" ";
        if ((array_key_exists("status", $context) && ((isset($context["status"]) ? $context["status"] : $this->getContext($context, "status")) == "résidant"))) {
            echo "class=\"active\"";
        }
        ...
        echo "\" ";
        if ((array_key_exists("status", $context) && ((isset($context["status"]) ? $context["status"] : $this->getContext($context, "status")) == "non valide"))) {
            echo "class=\"active\"";
        }
        ...
        <li class=\"";
        // line 29
        if (!twig_in_filter((isset($context["route"]) ? $context["route"] : $this->getContext($context, "route")), (isset($context["ReservationMenu"]) ? $context["ReservationMenu"] : $this->getContext($context, "ReservationMenu")))) {
            echo "not-";
        }
        echo "current\"><a href=\"";
        ...
        <li class=\"";
        // line 30
        if (!twig_in_filter((isset($context["route"]) ? $context["route"] : $this->getContext($context, "route")), (isset($context["logementMenu"]) ? $context["logementMenu"] : $this->getContext($context, "logementMenu")))) {
            echo "not-";
        }
        echo "current has-submenu\"><a href=\"";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("logement"), "html", null, true);
        echo "\" ";
        if (twig_in_filter((isset($context["route"]) ? $context["route"] : $this->getContext($context, "route")), (isset($context["logementMenu2"]) ? $context["logementMenu2"] : $this->getContext($context, "logementMenu2")))) {
            echo "class=\"active\"";
        }
        echo ">Logement</a></li>
                <li><a href=\"";
        ...
        echo "\" ";
        if (twig_in_filter((isset($context["route"]) ? $context["route"] : $this->getContext($context, "route")), (isset($context["blockMenu"]) ? $context["blockMenu"] : $this->getContext($context, "blockMenu")))) {
            echo "class=\"active\"";
        }
        echo ">Pavillon</a></li>
                <li><a href=\"";
        ...
        echo "\" ";
        if (twig_in_filter((isset($context["route"]) ? $context["route"] : $this->getContext($context, "route")), (isset($context["roomMenu"]) ? $context["roomMenu"] : $this->getContext($context, "roomMenu")))) {
            echo "class=\"active\"";
        }
        echo ">Chambre</a></li>
            </ul>
        ...
        <li class=\"";
            ...
            echo "\" ";
            if (twig_in_filter((isset($context["route"]) ? $context["route"] : $this->getContext($context, "route")), (isset($context["universityMenu"]) ? $context["universityMenu"] : $this->getContext($context, "universityMenu")))) {
                echo "class=\"active\"";
            }
            ...
            echo "\" ";
            if (twig_in_filter((isset($context["route"]) ? $context["route"] : $this->getContext($context, "route")), array(0 => "etablissement"))) {
                echo "class=\"active\"";
            }
            ...
            echo "\" ";
            if (twig_in_filter((isset($context["route"]) ? $context["route"] : $this->getContext($context, "route")), array(0 => "ben_import"))) {
                echo "class=\"active\"";
            }
            echo ">Importer</a></li>
            </ul>
        ...
        // line 49
        echo "        <li class=\"";
        if (((isset($context["route"]) ? $context["route"] : $this->getContext($context, "route")) != "fos_user_security_logout")) {
            echo "not-";
        }
        echo "current\"><a href=\"";
